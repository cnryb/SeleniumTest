...
namespace SeleniumTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            driver.Navigate().GoToUrl("https://www.cnblogs.com/news/");
  
            Thread.Sleep(500);
            var b = GetEntereScreenshot(driver);
            b.Save("t.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            driver.Quit();

        }

        static Bitmap GetEntereScreenshot(IWebDriver driver)
        {
